                  ...
                  <Card className="overflow-hidden transition-all duration-300 hover:shadow-xl border-border">
                    <CardContent className="p-0">
                      <div className="relative">
                        {/* Etiquetas del producto - MODIFICADO PARA AÑADIR ICONOS */}
                        <div className="absolute top-2 left-2 z-10 flex flex-col gap-1">
                          ...
                          {discountPercentage > 0 && !product.tag.includes("Descuento") && (
      ...
      isBestSeller?: boolean;
        ...
        return products.map(product => {
            ...
            const precioOriginal = descuento > 0 
                ? `S/${(parseFloat(formatPrice(product.precio).replace('S/', '')) / (1 - Number(product.descuento)/100)).toFixed(2)}`
                : precio;
            ...
            if (options.isBestSeller) {
              ...
              if (Number(product.descuento) > 0) tags.push("Descuento");
            } 
